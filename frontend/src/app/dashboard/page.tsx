        ...
        <div className="min-h-screen bg-[#09090b] text-white p-6 relative">
            ...
            <header className="max-w-4xl mx-auto mb-10 flex items-center justify-between relative z-10 pt-6">
                <div>
                    ...
                    <p className="text-gray-400 text-sm mt-1">Discover verified asymmetric ideas.</p>
                </div>
            ...
            <main className="max-w-4xl mx-auto space-y-6 relative z-10 pb-20">
                <AnimatePresence mode="popLayout">
                    {loading ? (
                        ...
                        >
                            <p className="text-gray-400">No active pitches found. Be the first!</p>
                        </motion.div>
                    ) : (
                                        ...
                                        <div className="flex items-center gap-4">
                                            ...
                                            <div>
                                                <div className="flex items-center gap-2">
                                                    <span className="font-medium text-gray-200">@{pitch.author_username}</span>
                                                    <span className="flex items-center gap-1 text-[10px] uppercase font-bold tracking-wider bg-emerald-500/20 text-emerald-400 px-2 py-0.5 rounded-full">
