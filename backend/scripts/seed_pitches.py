...
def seed_db():
    ...
    pitch_configs = [
        (
            ...
            "ATZ",
            55.00,
            "Aritzia demonstrates strong brand momentum and successful geographic expansion into the US market. Superior unit economics compared to traditional apparel retail.",
        ),
        (
            p2,
            "CSU",
            3500.00,
            "Constellation Software maintains an unparalleled track record of disciplined capital allocation and compounding through programmatic VMS acquisitions.",
        ),
        (
            p1,
            "EHC",
            110.00,
            "Encompass Health is positioned to benefit from aging demographics and continuous shift toward inpatient rehabilitation facilities.",
        ),
        (
            p2,
            "INVH",
            45.00,
            "Invitation Homes commands significant pricing power in the single-family rental market amidst structural national housing shortages.",
        ),
        (
            p1,
            "OWL",
            25.00,
            "Blue Owl Capital offers high structural growth in private credit. Alternative asset managers are capturing massive market share from traditional banking.",
        ),
        (
            p2,
            "SENEA",
            75.00,
            "Seneca Foods is a deeply undervalued, asset-rich agricultural player. Counter-cyclical properties provide a robust margin of safety.",
        ),
    ]
    ...
    print(
        f"Successfully seeded 6 authentic pitches with AWS S3 deck attachments for authors WarrenBuffett and CathieWood."
    )
