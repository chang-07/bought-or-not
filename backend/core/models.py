...
class Pitch(models.Model):
    ...
    author = models.ForeignKey(
        UserProfile, on_delete=models.CASCADE, related_name="pitches"
    )
...
class PitchAttachment(models.Model):
    pitch = models.ForeignKey(
        Pitch, on_delete=models.CASCADE, related_name="attachments"
    )
...
class TradeEvent(models.Model):
    reader = models.ForeignKey(
        UserProfile, on_delete=models.CASCADE, related_name="trades_executed"
    )
    pitch = models.ForeignKey(
        Pitch, on_delete=models.SET_NULL, null=True, related_name="triggered_trades"
    )
...
class HiddenPitch(models.Model):
    user = models.ForeignKey(
        UserProfile, on_delete=models.CASCADE, related_name="hidden_pitches"
    )
...
class PortfolioSnapshot(models.Model):
    user = models.ForeignKey(
        UserProfile, on_delete=models.CASCADE, related_name="portfolio_snapshots"
    )
